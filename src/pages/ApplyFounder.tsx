...
const ApplyFounder = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const submissionData = {
      ...formData,
      formType: 'Founder Application', // Ensure this is always set for this form
      emailConfigType: 'founder_group' // Special config for sending to info@ultiro.se group email
    };

    console.log('Submitting form data:', submissionData);

    try {
      console.log('Preparing to send form submission');
        ...
        try {
          ...
          // Only try to parse JSON if the content type is application/json and we have content
            ...
            try {
              ...
              setFormData({ name: '', email: '', phone: '', linkedin: '', message: '', formType: 'Founder Application' });
              setSubmitStatus({ type: 'success', message: result.message || 'Application submitted successfully! We will be in touch soon.' });
            } catch (jsonError) {
